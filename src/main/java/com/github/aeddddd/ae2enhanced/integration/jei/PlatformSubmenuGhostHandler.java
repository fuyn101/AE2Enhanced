...
/**
 * JEI Ghost Ingredient Handler for Advanced Platform Controller submenu GUI.
 * Supports dragging items/fluids/gases/essentia into the 50 IO config slots.
 */
public class PlatformSubmenuGhostHandler implements IGhostIngredientHandler<GuiAdvancedPlatformSubmenu> {

    @Nonnull
    @Override
    public <I> List<Target<I>> getTargets(@Nonnull GuiAdvancedPlatformSubmenu gui, @Nonnull I ingredient, boolean doStart) {
