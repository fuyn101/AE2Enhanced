...
public final class ModItems {
    ...
    public static final RegistryObject<Item> MULTIBLOCK_INTERFACE = DR.register("multiblock_interface",
            () -> new BlockItem(ModBlocks.MULTIBLOCK_INTERFACE.get(), new Item.Properties()));
